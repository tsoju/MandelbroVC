...
static const char qt_meta_stringdata_viewmain[] = {
    "viewmain\0"
};
...
const QMetaObjectExtraData viewmain::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject viewmain::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_viewmain,
      qt_meta_data_viewmain, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &viewmain::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_viewmain))
        return static_cast<void*>(const_cast< viewmain*>(this));
    if (!strcmp(_clname, "Ui::MainWindow"))
        return static_cast< Ui::MainWindow*>(const_cast< viewmain*>(this));
